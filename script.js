...
setInterval(function () {
  ...
  if (de.value == "USD" && para.value == "BRL") {
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 5.4).toFixed(2);
      simbolo.innerText = "R$";
    }
  }
  ...
  //Real para dolar
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 0.18).toFixed(2);
      simbolo.innerText = "$";
    }
  }
  ...
  //Real para Euro
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 0.15).toFixed(2);
      simbolo.innerText = "€";
    }
  }
  ...
  //Euro para Real
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = (parseFloat(input.value) * 6.6).toFixed(2);
      simbolo.innerText = "R$";
    }
  }
  ...
  //Moeda propria
    ...
    if (input.value <= 0) {
      ...
      valor.innerText = parseFloat(input.value).toFixed(2);
      if (para.value == "USD") {
        simbolo.innerText = "$";
      } else if (para.value == "BRL") {
        simbolo.innerText = "R$";
